!(function (t, e) {
  ...
  var t = (function () {
    ...
    return (
      ...
      (t.prototype.createSetter = function () {
        this.setter = {
      ...
      (t.prototype.removeText = function () {
        this.removeState(this.options.textState), this.removeSkewing();
      }),
      (t.prototype.setIcon = function (t, e) {
        void 0 === e && (e = ""),
          (this.text.innerHTML =
            "<svg class='" +
      ...
      (t.prototype.removeMedia = function () {
        var t = this;
        clearTimeout(this.mediaInt),
      ...
      (t.prototype.getFromDataset = function (t) {
        var e = t.dataset;
        return {
